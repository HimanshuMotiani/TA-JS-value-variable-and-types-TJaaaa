...
*/
// [Your code goes here]
let integer = +prompt("Enter the value");
let str = "h"
...
let val3 = +prompt("Enter the third number");
let product = val1 * val2 * val3;
if (product < 0) {
  alert(`${product}`)
} else
  alert(`+${product}`)
...
// [Your code goes here]
let cal1 = +prompt("Enter the first number");
let cal2 = +prompt("Enter the second number");
